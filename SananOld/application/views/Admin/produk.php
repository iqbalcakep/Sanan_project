    ...
    <div class="main_container">
      ...
      <?php
       if($this->session->flashdata('error_upload')) {
				$message = $this->session->flashdata('error_upload');?>
				<div class="<?php echo $message['class'] ?>"><?php echo $message['message']; ?></div><?php } ?>
			  <h1>DAFTAR PRODUK</h1> <a class="btn btn-success" href="<?= site_url();?>/Admin/Produk/addProduk">Tambah Data</a>
			  <hr>
              <table id="table" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr><th>Nama </th><th>Kategori</th><th>Stok</th><th>Harga</th><th>foto</th><th>Aksi</th><th></th></tr>
                </thead>
                <tbody>
                </tbody>
            </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({ 
                    ...
                    "ajax": {
                        "url": '<?php echo site_url('Admin/Produk/getProduk'); ?>',
                        "type": "POST"
                    },
