...
<?php foreach($produk as $d ){ ?>
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Edit Produk Anda <small></small></h2>
                    ...
                    <div class="profile_img">
                      ...
                      <div id="crop-avatar">
                        ...
                        <div class="avatar-view" title="Change the avatar">
                          <img src="<?php echo base_url() ?>assets/images/produk/<?php echo $d['foto1'];?>" alt="Foto 1">
    ...
    <?php echo form_open_multipart('Admin/Produk/editFotoa', array('enctype'=>'multipart/form-data','id'=>'demo-form2','data-parsley-validate', 'class'=>'form-horizontal form-label-left')); ?>  
    
<div class="form-group">
  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Foto 1 <span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6 col-xs-12">
  <input type="hidden" value="<?php echo $d['id_produk']; ?>"  name="id_produk" >
    <input type="file"  id="first-name" name="foto1" >
  </div>
</div>
...
<div id="crop-avatar">
  <!-- Current avatar -->
  <div class="avatar-view" title="Change the avatar">
    <img src="<?php echo base_url() ?>assets/images/produk/<?php echo $d['foto2'];?>" alt="Foto 1">
...
<?php echo form_open_multipart('Admin/Produk/editFotob', array('enctype'=>'multipart/form-data','id'=>'demo-form2','data-parsley-validate', 'class'=>'form-horizontal form-label-left')); ?>  

<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Foto 2 <span class="required">*</span>
</label>
<div class="col-md-6 col-sm-6 col-xs-12">
<input type="hidden" value="<?php echo $d['id_produk']; ?>"  name="id_produk" >
<input type="file"  id="first-name" name="foto2" >
</div>
</div>
<button type="submit" class="btn btn-success"><i class="fa fa-edit m-right-xs"> Edit Foto</i></button>
...
<?php echo form_close(); ?>
           ...
           <div class="x_content">
                  <br />
                  <?php echo form_open('Admin/Produk/editProdukData', array('id'=>'demo-form2','data-parsley-validate', 'class'=>'form-horizontal form-label-left')); ?>  
                  <input type="hidden" value="<?php echo $d['id_produk']; ?>"  name="id_produk" >
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" value="<?php echo $d['nama_produk']; ?>" id="first-name" name="nama" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                      <select id="id_kategori" name="id_kategori" class="form-control col-md-7 col-xs-12" >
                        ...
                        <option <?= $selected; ?> value="<?php echo $kat['id_kategori']; ?>"><?php echo $kat['nama_kategori'];  ?></option>
                        <?php } ?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" value="<?php echo $d['stok_produk']; ?>" id="first-name" name="stok" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" value="<?php echo $d['harga_produk']; ?>" id="first-name" name="harga" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                       <textarea name="deskripsi" required="required" class="form-control col-md-7 col-xs-12"><?php echo $d['deskripsi_produk']; ?></textarea>
                      </div>
                    </div>
