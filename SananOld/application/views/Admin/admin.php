...
<script src="<?php echo base_url() ?>assets/js/jquery.dataTables.min.js"></script>
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <br><br>
      <?php
       if($this->session->flashdata('error_delete')) {
				$message = $this->session->flashdata('error_delete');?>
				<div class="<?php echo $message['class'] ?>"><?php echo $message['message']; ?></div><?php } ?>
			  <h1>DAFTAR ADMIN</h1>
			  <hr>
              <table id="table" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr><th>Nama</th><th>Username</th><th>Alamat</th><th>Email</th><th>Notelp</th><th>Foto</th><th>Level</th><th>Aksi</th></tr>
                </thead>
                <tbody>
                </tbody>
            </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({ 
                    ...
                    "ajax": {
                        "url": '<?php echo site_url('Admin/Admin/getAdmin'); ?>',
                        "type": "POST"
                    },
