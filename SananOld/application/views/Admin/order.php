  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		  ...
		  <br><br>
			  <h1>Pesanan Butuh Konfirmasi</h1>
			  <hr>
              <table id="table" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr><th>ID Order</th><th>Nama Customer</th><th>Judul Iklan</th><th>Tanggal Order</th><th>Aksi</th></tr>
                </thead>
                <tbody>
                </tbody>
            </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({ 
                    ...
                    "ajax": {
                        "url": '<?php echo site_url('Admin/Order/json'); ?>',
                        "type": "POST"
                    },
...
<br><br>
              ...
              <table id="table1" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr><th>ID Order</th><th>Nama Customer</th><th>Judul Iklan</th><th>Tanggal Order</th><th>Status Order</th></tr>
                </thead>
                <tbody>
                </tbody>
            </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table1').DataTable({ 
                    ...
                    // Load data for the table's content from an Ajax source
                    "ajax": {
                        "url": '<?php echo site_url('Admin/Order/jsonlain'); ?>',
                        "type": "POST"
                    },
                    //Set column definition initialisation properties.
                    "columns": [
