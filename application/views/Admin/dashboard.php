...
<head>
  ...
  <title>Admin TempeSanan.com </title>
          ...
          <div class="row">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div style="float:left;" class="col-md-3 col-sm-3 col-xs-12 profile_left">
                    ...
                    <h3><?php echo $d['nama_admin'];?></h3>

                    <a href="<?php echo site_url() ?>/Admin/dashboard/editAdmin" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
           ...
           <div class="col-md-9 col-sm-9 col-xs-12" style="valign:top;">
              <table class="table" style="">
                ...
                <td ><?php echo $d['notelp_admin']; ?></td>
                </tr>
                <tr>
                <th style="">Alamat</th>
                <td ><?php echo $d['alamat_admin']; ?></td>
                </tr>
              </table>
