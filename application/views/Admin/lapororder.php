      ...
      <div class="right_col" role="main">
		  ...
		  <br><br>
              ...
              <table id="table" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr><th>ID Order</th><th>Nama Customer</th><th>Judul Iklan</th><th>Tanggal Order</th><th>Status</th></tr>
                </thead>
                <tbody>
                </tbody>
            </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
             ...
             "scrollX": true,
                    ...
                    "ajax": {
                        "url": '<?php echo site_url('Admin/lapororder/json'); ?>',
                        "type": "POST"
                    },
        ...
        <div class="col-md-9 col-sm-9 col-xs-12" style="valign:top;">
           <div class="x_content">
           <?php echo form_open('Admin/Lapororder/detail'); ?>
                  <br />
