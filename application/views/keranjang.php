...
<html>
<head>
<title>Keranjang | Kripik Tempe Sanan</title>
<!-- for-mobile-apps -->
	      ...
	      <div class="checkout-right">
				...
				<table class="timetable_sub">
					...
					<tbody><tr class="rem1">
						...
						<td class="invert-image"><a href="<?php echo base_url() ?>index.php/home/detail"><img src="<?php echo base_url() ?>assets/images/1.png" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
					...
					<tr class="rem2">
						...
						<td class="invert-image"><a href="<?php echo base_url() ?>index.php/home/detail"><img src="<?php echo base_url() ?>assets/images/3.png" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem3">
						...
						<td class="invert-image"><a href="<?php echo base_url() ?>index.php/home/detail"><img src="<?php echo base_url() ?>assets/images/2.png" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
			...
			<div class="checkout-left">	
				...
				<form action="<?php echo base_url() ?>index.php/home/pembayaran" method="post" class="creditly-card-form agileinfo_form">
				        	...
				        	<a href="<?php echo base_url() ?>index.php/home/pembayaran">Make a Payment <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>
			      	</div>
					</div>
